...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002536193251 -1002434598772 -1002194129597').split()]  # Channel id for auto indexing (make sure bot is admin)
